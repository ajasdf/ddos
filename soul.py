...
user_attacks = {}
bot_token = '7221165619:AAFQdC2wcgR-alBkKnOxquDqug7L4jQoANw'
...
def handle_start(message):
    ...
    bot.send_message(message.chat.id, "welcome to AJ ddos @ANTRIKSH00:", reply_markup=markup)
